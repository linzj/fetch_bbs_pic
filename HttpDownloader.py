...
class HttpDownloader(object):
    ...
    def get_base_header(self, http_request):
    ...
    def download(self, http_request):
        ...
        self.set_base_header(opener, http_request)
        try:
    ...
    def set_base_header(self, opener, http_request):
        opener.addheaders = self.get_base_header(http_request)
